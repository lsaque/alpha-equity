    ...
    <section id="inicio">
      <div id="activeCarousel0" className="carousel slide " data-bs-ride="carousel">
        <div className="carousel-indicators">
          <button type="button" data-bs-target="#activeCarousel0" data-bs-slide-to="0" className="active"
        ...
        <div className="carousel-inner">
          ...
          <div className="carousel-item active">
            ...
            <div className="center-content">
              ...
              <div className="p-box">
                <p className="h2">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor
                  invidunt ut labore et ut labore et</p>
              </div>
            </div>
          </div>
        ...
        <button className="carousel-control-prev d-none d-lg-block" type="button" data-bs-target="#activeCarousel0"
          data-bs-slide="prev">
          <span className="carousel-control-prev-icon" aria-hidden="true"></span>
          <span className="visually-hidden">Previous</span>
        </button>

        <button className="carousel-control-next d-none d-lg-block" type="button" data-bs-target="#activeCarousel0"
          data-bs-slide="next">
